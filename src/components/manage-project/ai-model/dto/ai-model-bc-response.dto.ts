...
export class BcArtifactModelDetailsDto {
    @ApiProperty({
        example: 'tsd_model_0',
        description: 'Artifact model name'
    })
    modelArtifactName: string;

    @ApiProperty({
        example: 'e202b86e0e58026994616fa5957a3a199ffc7d7b2b421365c30ed1b238b2b252',
        description: 'hash of artifact model data'
    })
    ...
    @ApiProperty({
        example: new Date(),
        description: 'Recorded date of artifact model in blockchain state'
    })
    recordDate: Date;
...
export class BcArtifactModelHistoryDto {
    @ApiProperty({
        example: '92af9443a6ba663309318647c88f4931cad444cf4cff90ecfedb15957b856c76',
        description: 'blockchain transaction Id'
    })
    ...
    @ApiProperty({
        example: BcArtifactModelDetailsDto,
        description: 'Data of arifact model',

        format: 'object'
    })
    modelArtifact: BcArtifactModelDetailsDto;
}
