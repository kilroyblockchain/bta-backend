...
@Global()
@Module({
    imports: [MongooseModule.forFeature([{ name: 'ai-model', schema: AiModelSchema }]), forwardRef(() => MailModule), OrganizationStaffingModule, OrganizationUnitModule, UserModule, ProjectVersionModule, HttpModule],
